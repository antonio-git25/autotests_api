...
from fixtures.fixt_files import FileFixture
from tools.base_validation import assert_status_code
from tools.files_validation import assert_create_file_response, assert_get_file_response, \
...
from tools.schema import validate_json_schema
...
class TestFiles:
    ...
    def test_create_file_with_empty_directory(self, files_client: FilesClient):
        request = CreateFileRequestSchema(
            directory="",
            upload_file="./testdata/9a4669ae.png"
        )
        response = files_client.create_file_api(request)
    ...
    def test_create_file_with_empty_file_name(self, files_client: FilesClient):
        request = CreateFileRequestSchema(
            filename="",
            upload_file="./testdata/9a4669ae.png"
        )
